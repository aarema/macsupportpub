#!/bin/bash
# Original idea from https://github.com/aysiu/Mac-Scripts-and-Profiles/blob/master/ChromeDefaultBrowser.sh
# Debugged and heavily modified for Jamf Pro deployment by primalcurve 08/22/2017
